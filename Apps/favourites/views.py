...
class FavouriteList(CustomLoginRequriedMixin, generics.ListAPIView):
...
class FavouriteAdd(CustomLoginRequriedMixin, generics.CreateAPIView):
...
class FavouriteDelete(CustomLoginRequriedMixin,generics.DestroyAPIView):
    queryset = Favourite.objects.all()
    serializer_class = FavouriteSerializer
    lookup_field = 'id'
